            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="<?= Helper::routename('admin.dashboard')?>">
                        ...
                        <div class="collapse" id="collapsePages" aria-labelledby="headingTwo"
                            data-parent="#sidenavAccordion">
                            <a class="nav-link" href="<?= Helper::routename('admin.partner')?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Partenaire
                            </a>

                            <a class="nav-link" href="<?= Helper::routename('admin.coach')?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Coachs
                            </a>
                            <a class="nav-link" href="<?= Helper::routename('admin.team')?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Joueurs
                            </a>
